...
if ($selectinvt == 0) {
	...
	for ($i = $strto; $i <= $upto; $i++) {
		if (!${'SKIPMONITORING' . $i}) {
			...
			echo "<tr align='center'><td><img src='images/24/sign-error.png' width=24 height=24 border=0> <a href='dashboard.php?invtnum=$i'>${'INVNAME'.$i} skipped</a></td><td><span id='GPTOT$invtnum'>--</span> W</td></tr>";
		}
	}
	echo "</table>";
} else {
